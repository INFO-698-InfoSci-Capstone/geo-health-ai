...
fig1 = px.choropleth(Unioned_Data_FIPS, geojson = counties_geojson,
                    locations = 'FIPS_Code', color='%NHOPIDiabetes',
                    color_continuous_scale = "Viridis",scope = "usa",
                    animation_frame = 'year',
                    title = 'Arizona County Heatmap Native Hawaiian and Pacific Islander Diabetes',
                    labels = {'%NHOPIDiabetes':'Diabetes<br>Percent'},
                    range_color = [10,25],
